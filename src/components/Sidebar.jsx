...
export default function Sidebar() {
  const handleSignOut = () => {
    ...
    }, 1000); // short delay so toast shows before redirect
  };
  ...
  return (
    <div className="w-64 bg-black text-white min-h-screen flex flex-col">
      ...
      <nav className="flex-1 mt-4 space-y-1">
        <a
          href="#"
          className="flex items-center gap-3 px-4 py-3 bg-gray-800 text-white border-r-2 border-orange-500"
        >
      ...
      <div
        ...
        className="flex items-center gap-3 px-4 py-3 text-gray-300 border-t border-gray-800 hover:bg-gray-800 cursor-pointer"
      >
